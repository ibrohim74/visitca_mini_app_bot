                        ...
                        return(
                            <div key={index} className={style.bookingUser_booking_item}>
                                ...
                                <div className={style.bookingUser_booking_item_col3}>
                                    <div className={style.bookingUser_booking_item_col3_i1}>
                                        <h1>Предложенно :</h1>
                                        <h1>{item.start_price} {announcement[index]?.price_type}</h1>
                                    </div>
